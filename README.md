...
```bash
git clone https://anonymous.4open.science/r/hypothesis-generation-87E8/
...
The datasets used in our works are at https://anonymous.4open.science/r/HypoGeniC-datasets-3CC8/README.md.
