...
def parse_args():
    ...
    parser.add_argument('--num_init', type=int, default=25,
                        help='Number of examples to use for initializing hypotheses.')
    parser.add_argument('--init_hypotheses_per_batch', type=int, default=5,
                        help='Number of hypotheses to generate per batch')
    ...
    parser.add_argument('--k', type=int, default=-1,
                        help='The number of hypotheses checked per sample during training.')
    parser.add_argument('--max_num_hypotheses', type=int, default=20,
                        help='Maximum number of hypotheses to keep in the hypotheses bank.')
    parser.add_argument('--num_hypotheses_to_update', type=int, default=5,
    ...
    parser.add_argument('--generation_style', type=str, choices=GENERATION_DICT.keys(),
                        help='types of generation methods')
    ...
    parser.add_argument('--num_wrong_to_add_bank', type=int, default=0,
                        help='The number of hypotheses the sample it must be added the wrong examples bank. Must be greater than 1')
    parser.add_argument('--num_wrong_scale', type=float, default=0.8, help='Scale for dynamic num_wrong_to_add_bank')
    parser.add_argument('--only_best_hypothesis', type=bool, default=False,
    ...
    parser.add_argument('--old_hypothesis_file', type=str, default=None,
                        help='Previously generated hypotheses to restart generation from')
    ...
    parser.add_argument('--epoch_to_start_from', type=int, default=0,
                        help='Epoch number to start from. When restarting, this should be > 1.')
    parser.add_argument('--current_epoch', type=int, default=-1,
                        help='To keep track of current epoch, DO NOT CHANGE THIS.')
