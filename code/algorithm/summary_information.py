...
class SummaryInformation:
    def __init__(self,
        ...
        self.reward = reward
        self.correct_examples = correct_examples # a list of tuples of the form (sample index, label)
    ...
    def update_reward(self, alpha, num_examples):
        self.reward = self.acc + alpha * math.sqrt(math.log(num_examples) / self.num_visits)
