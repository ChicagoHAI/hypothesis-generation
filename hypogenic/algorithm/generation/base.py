...
class Generation(ABC):
    ...
    def __init__(
        ...
        Parameters:
            api: The LLM API to call for initialization and batched hypothesis generation
    ...
    def batched_initialize_hypotheses(
        ...
        **kwargs
        ...
        Parameters:
            num_init: Total number of hypotheses to generate during initialization phase
            init_batch_size: Number of samples to process in each batch
            init_hypotheses_per_batch: Number of hypotheses to generate per batch
            cache_seed: Cache seed, if None will not use cache, otherwise will use cache with corresponding seed number
            max_concurrent: Maximum number of concurrent requests to make to the API
    ...
    def make_hypotheses_bank(
        ...
        **generate_kwargs
        ...
        Parameters:
            ...
            hypotheses_list: the list of hypotheses that we want to make bank for
            cache_seed: If `None`, will not use cache, otherwise will use cache with corresponding seed number
